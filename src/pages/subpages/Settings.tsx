      ...
      <div className="w-full max-w-5xl mx-auto space-y-6">
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="inline-flex items-center gap-1 p-1 rounded-xl bg-[var(--bg)] border border-[var(--border)] shrink-0">
              <button
                ...
                className={`flex items-center gap-1.5 px-3 h-8 rounded-lg text-xs font-semibold transition disabled:opacity-60 ${
                  theme === "light"
        ...
        {!isAdmin && (
          <section className="bg-[var(--card)] border border-red-200 dark:border-red-900/40 rounded-lg p-5 transition-colors">
            <h2 className="font-semibold text-sm text-red-700 dark:text-red-400 mb-2">Danger Zone</h2>
            ...
            {!showDeleteConfirm ? (
              <button
                ...
                className="h-9 px-3 rounded-lg border border-red-300 dark:border-red-800 text-red-700 dark:text-red-400 text-xs font-semibold hover:bg-red-50 dark:hover:bg-red-950/30"
              >
                Delete account
              </button>
            ) : (
